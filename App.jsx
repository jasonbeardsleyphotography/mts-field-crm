...
export default function App() {
  ...
  const speakStop = async (stop) => {
    ...
    // Path 1: Gemini TTS. Model must support AUDIO output — regular flash
    // variants only do text. The "tts-preview" models return raw PCM that
    // we wrap in a WAV header before playing.
    if (geminiKey) {
      try {
